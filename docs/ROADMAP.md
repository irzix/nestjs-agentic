...
- [x] Cancellation-aware fan-out and bounded parallel execution (`maxConcurrency` in `ParallelSubAgentRunner`).
...
- [ ] Bounded concurrency and cancellation-aware fan-out join behavior ([#35](https://github.com/irzix/nestjs-agentic/issues/35)).
